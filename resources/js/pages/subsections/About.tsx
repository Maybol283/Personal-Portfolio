...
export default function About() {
    ...
    return (
        <div className="px-4 pb-16 md:px-8 lg:px-16" id="about" ref={about}>
            ...
            <div className="mx-auto max-w-7xl">
                ...
                <a.h1
                    style={upFade}
                    ref={ref}
                    className="subtitle-text mb-8 text-center font-bold"
                >
                    About Me
                </a.h1>

                <div className="grid grid-cols-1 md:grid-cols-2 3xl:grid-cols-1 gap-6">
                    {/* Bio content */}
                    <a.div
                        style={leftFade}
