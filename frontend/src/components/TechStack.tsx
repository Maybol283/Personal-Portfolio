...
export default function TechStack() {
  return (
    <div className="overflow-hidden py-10 text-center subtitle-text size-full pb-5 bg-palette-4">
      <div className="bg-palette-2">
        ...
        <div className=" text-left py-5 sm:py-15 justify-items-center flex flex-wrap gap-4 place-content-evenly">
          <div className=" rounded-lg bg-palette-4 shadow-lg shadow-palette-4 lg:py-5">
